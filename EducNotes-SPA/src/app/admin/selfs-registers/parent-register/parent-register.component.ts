...
export class ParentRegisterComponent implements OnInit {
 ...
 sameLocation: false;
  ...
  ngOnInit() {
    ...
    this.parentTypeId = this.user1.userTypeId;
   ...
   this.editModel.secondPhoneNumber = '';
    ...
    createChildForm() {
      ...
      this.childForm = this.fb.group({
        ...
        userName: [this.editModel.lastName, Validators.required],
        password: ['', Validators.required],
 ...
 save() {
   ...
   this.authService.parentSelfPreinscription(this.userId, data).subscribe(() => {
